<%-- 
    Document   : error
    Created on : Sep 4, 2016, 2:29:05 PM
    Author     : Dusan
--%>
...
<html
    ...
    %>
       ...
       if(request.getSession().getAttribute("korisnik") == null)
        {%>
            ...
            <li><a href="${pageContext.request.contextPath}/customer/index.jsp"><i class="fa fa-sign-in"></i><span>Login</span></a></li>
            <%}
        else
        {
        %>
    ...
    <h2 style="color:#eee;">${errormsg}</h2>
