<%-- 
    Document   : orders
    Created on : Apr 29, 2016, 5:09:25 PM
    Author     : Dusan
--%>
...
<%
    ...
    String sqlPagination="SELECT SQL_CALC_FOUND_ROWS * FROM narudzbine limit "+iPageNo+","+iShowRows+"";
...
<html
    ...
    <span class="headerLine"></span>
        ...
        <tr>
          ...
          <td><%=rsPagination.getString("korisnik_imeprezime")%></td>
          <td><%=rsPagination.getString("proizvod_naziv")%></td>
          <td><%=rsPagination.getString("proizvod_cena")%></td>
          <td><%=rsPagination.getString("kolicina")%></td>
          <td><%=rsPagination.getString("ukupna_cena")%></td>
          <td><%=rsPagination.getString("adresa_dostave")%></td>
          <td><%=rsPagination.getString("datum_dostave")%></td>
          <td><%=rsPagination.getString("kategorija")%></td>
          <td><a class='btn act' href="${pageContext.request.contextPath}/DeleteOrder?id=<%=rsPagination.getInt("id")%>">DELETE</a></td>
        </tr>
...
%>                     
        ...
        {
         %>
          <a class='btnpagi pagi' href="${pageContext.request.contextPath}/admin/index.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"> << Previous</a>
         <%
        }
        ...
        for(i=((cPage*iTotalSearchRecords)-(iTotalSearchRecords-1));i<=(cPage*iTotalSearchRecords);i++)
        {
          ...
          {
          %>
           <a class='btnpagi pagi' href="${pageContext.request.contextPath}/admin/index.jsp?iPageNo=<%=i%>" style="color: #59d"><b><%=i%></b></a>
          <%
          }
          else if(i<=iTotalPages)
          {
          %>
           <a class='btnpagi pagi' href="${pageContext.request.contextPath}/admin/index.jsp?iPageNo=<%=i%>"><%=i%></a>
          <% 
          }
        }
        ...
        {
         %>
         <a class='btn act' href="${pageContext.request.contextPath}/admin/index.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>"> >> Next</a> 
         <%
        }
        }
      %>
